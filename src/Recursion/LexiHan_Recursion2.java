...
public class LexiHan_Recursion2 {
	...
	public static void main(String[] args) {
      ...
      System.out.println("Given the following grid:");
      System.out.println();
      for (int i = 0; i < 4; i++){
         for (int j = 0; j < 4; j++){
      ...
      System.out.println();
		System.out.println("The minimum cost of travelling from the bottom left to the top right is: " + b.minCost(0, 3, grid) + " dollars.");
	}
}	
